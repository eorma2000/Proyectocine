...
class RegistroEmpleado():
    ...
    def getLabels(self):
        ...
        eti1 = Label(self.marco, fg="white", bg="black", font=("courier", 25, "italic", "bold"),
                     text="REGISTRO EMPLEADOS").place(x=180, y=0)
    ...
    def getInputs(self):
        posX = 350
        self.id_cedula_empleado = Entry(self.marco,font=("italic",18))
        self.id_cedula_empleado.place(x=posX,y=100,width=180,height=25)

        self.nombre_empleado = Entry(self.marco,font=("italic",18))
        self.nombre_empleado.place(x=posX,y=200,width=180,height=25)

        self.correo_empleado = Entry(self.marco,font=("italic",18))
        self.correo_empleado.place(x=posX,y=250,width=180,height=25)

        self.contraseña_empleado = Entry(self.marco,font=("italic",18))
        self.contraseña_empleado.place(x=posX,y=150,width=180,height=25)
    ...
    def getButtons(self):
        ...
        self.cancelar = Button(self.marco, relief="groove",
                                   ...
                                   command=self.ven1.destroy).place(x=360, y=325,
                                                                    width=110, height=40)
    def grabar(self):
        datos=(self.id_cedula_empleado.get(),self.nombre_empleado.get(),
               self.correo_empleado.get(),self.contraseña_empleado.get())
        msg = self.crud.insertEmpleado("proyectocine",datos)
    ...
    def getUser(self):
        ...
        obj = self.crud.validateEmpleado("proyectocine",datos)
        if obj==None:
    ...
    def activate(self,estado,estadoB):
        ...
        self.nombre_empleado['state'] = estado
        self.correo_empleado['state']=estado
        self.contraseña_empleado['state'] = estado
