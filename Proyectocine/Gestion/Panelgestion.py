...
from Proyectocine.Gestion.Clientes import *
from Proyectocine.Gestion.Empleados import *
from Proyectocine.Gestion.Peliculas import *
...
class Panelg():
    ...
    def getlabel(self):
        ...
        eti2 = Label(self.ventana, fg="white", bg="black", font=("courier", 20, "italic", "bold"),
                     text="PANEL GESTIÓN").place(x=105, y=20)
