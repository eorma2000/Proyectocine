...
from Proyectocine.Edicion.empleados import *
...
class Gempleados():
    ...
    def __init__(self, titulo=None):
        ...
        self.lista = self.crud.getAllEmpleados("proyectocine")
    ...
    def getMarco(self):
        self.marco = Frame(self.ven1,bd=7,bg="#B07CDA", highlightthickness=11, highlightbackground="silver")
    ...
    def getLabels(self):
        ...
        eti2 = Label(self.ven1, fg="black",bg="#B07CDA",text="Ingrese Nº Cédula:",font=("Calibri", 15)).place(x=80, y=90)
    ...
    def ShowTable(self, lista=None):
        ...
        for i in range(len(lista)):
            self.tabla.insert("", "end", values=(str(i + 1),
                                                 lista[i].id_cedula_empleado,
                                                 lista[i].nombre_empleado,
                                                 lista[i].correo_empleado,
                                                 lista[i].contraseña_empleado))
    ...
    def onClick(self, event):
        ...
        if text != "":
            ...
            if self.clk == 0 and self.nfila[0] == self.nfila[1]:
                frm = EdicionEmpleado(self.lista[posi - 1])
        else:
            self.clk = 0
    ...
    def filtro(self):
        ...
        self.lista = self.crud.filterEmpleado("proyectocine", datos)
        if self.lista != []:
            self.ShowTable(self.lista)
